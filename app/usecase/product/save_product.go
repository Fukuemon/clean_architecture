...
import (
	"context"
	productDomain "github/Fukuemon/clean_architecture/domain/product"
)
...
func (uc *SaveProductUseCase) Run(ctx context.Context, input SaveProductUseCaseInputDto) (*SaveProductUseCaseOutputDto, error) {
